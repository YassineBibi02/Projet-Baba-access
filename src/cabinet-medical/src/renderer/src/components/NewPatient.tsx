        ...
        <div className="ps-card">
          <div className="np-form">
            ...
            <div className="np-row">
              ...
              <Lookup size="sm" value={form.lieu_naissance} onChange={v => set('lieu_naissance', v)} />
              <span className="np-lbl">Sexe</span>
              <Lookup size="xs" value={form.sexe} onChange={v => set('sexe', v)} />
              <span className="np-lbl">Situation</span>
              <Lookup size="md" value={form.situation_famille} onChange={v => set('situation_famille', v)} />
